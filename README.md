...
| `matrix-grid-tool/` | A standalone, unrelated browser tool (not a Krita plugin) that generates black/white or gray/black square grid reference images for AI image generation. See its own README. |
